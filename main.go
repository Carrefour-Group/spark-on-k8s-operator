...
func main() {
	...
	if *enableWebhook {
		...
		hook, err = webhook.New(kubeClient, crInformerFactory, namespaceConfig.Namespace, !*enableLeaderElection, *enableResourceQuotaEnforcement, coreV1InformerFactory, webhookTimeout)
		if err != nil {
			glog.Fatal(err)
		}
